...
all_avg_throughputs_proposed = []
all_avg_throughputs_conventional = []
...
for step_size in step_sizes:
    ...
    all_avg_throughputs_conventional.append(avg_conventional_throughput)
    all_avg_throughputs_proposed.append(avg_proposed_throughput)
...
print('all_avg_throughputs_proposed: ', all_avg_throughputs_proposed)
print('all_avg_throughputs_conventional: ', all_avg_throughputs_conventional)
...
plt.legend()
plt.grid(True)
plt.savefig('step_size_vs_throughput_plot.png')
plt.show()
